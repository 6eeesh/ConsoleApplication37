...
public:
    Student(string first, string last) : grades_math(nullptr), grades_physics(nullptr), grades_chemistry(nullptr),
        num_grades_math(0), num_grades_physics(0), num_grades_chemistry(0) {
        SetFirstName(first);
        SetLastName(last);
    }
